...
def scrape_edx(keyword):

    formatted_keyword = format_edx(keyword)

    # example
    url = "https://www.edx.org/search?q=python&tab=course"

    # url = "https://www.edx.org/search" + formatted_keyword
    ...
    for div in soup.findAll('div', attrs={'class': "discovery-card Verified and Audit col col-xl-3 mb-4 scrollable-discovery-card-spacing"}):
